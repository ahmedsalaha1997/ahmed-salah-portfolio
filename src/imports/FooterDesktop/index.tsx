import svgPaths from "./svg-2m5ykxz4d6";

function Copyright() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center min-w-px py-[16px] relative" data-name="Copyright @2024">
      <div className="[word-break:break-word] flex flex-col font-['IBM_Plex_Sans:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[16px] text-white whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
...
export default function FooterDesktop() {
  return (
    <div className="relative size-full" data-name="Footer - Desktop">
      <div className="content-stretch flex items-center justify-between px-[200px] relative size-full">
        <Copyright />
        <Logo />
      </div>
